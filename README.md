...
### ⚛️ MPhil/MS Research — Quantum Machine Learning

I am currently conducting research in **Quantum Machine Learning (QML)** with a focus on the trainability and performance of **Variational Quantum Classifiers (VQCs)** using simulation-based experiments.

**Research Topic:**

> **A Simulation-Based Study of Data Encoding and Circuit Depth Effects on the Trainability of Variational Quantum Classifiers**

### 🎯 Research Focus

- ⚛️ Variational Quantum Classifiers (VQC)
- 🧬 Variational Quantum Circuits
- 🔢 Quantum Data Encoding / Feature Maps
- 📐 Circuit Depth and Model Complexity
- 🧠 Trainability of Quantum Machine Learning Models
- 📉 Optimization and Convergence
- 🔗 Quantum-Classical Hybrid Learning
- 🧪 Simulation-Based Quantum Experiments
- 📊 Performance Evaluation of Quantum Models
- ⚙️ Noise, scalability, and computational limitations

### 🧪 Research Methodology

My research investigates how different **data encoding strategies** and **quantum circuit depths** influence the trainability and learning performance of Variational Quantum Classifiers.

The study focuses on simulation-based experimentation, allowing systematic evaluation of:
